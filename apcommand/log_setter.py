...
LOG_FORMAT = "%(levelname)s,%(threadName)s,%(funcName)s,Line: %(lineno)d,%(asctime)s,%(message)s" 
...
def set_logger(args):
    ...
    """
    # Since this is meant to be run as a one-time command, saving the logs seems unnecessary
    #cleanup()
